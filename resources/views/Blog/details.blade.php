        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="flex align-items-center" style="padding: 20px; margin-bottom: 30px; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
                    <img src="https://i.pinimg.com/originals/9c/13/0f/9c130f4a650c7f7c799a898d101c474c.jpg" class="rounded-circle float-left" style="width: 120px; margin-right: 20px;" alt="">
                    <div>
                ...
                <div class="flex align-items-center" style="padding: 20px; margin-bottom: 30px; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
                    <div style="margin-bottom: 30px;">
                        @if ($blogs->comments)
                            <h4 style="font-weight: bold;">{{$blogs->comments->count()}} Comments</h4>
                            @foreach ($blogs->comments as $comment)
                                <div style="margin-top: 30px; position: relative;border: 2px solid gray; border-radius: 10px ;padding: 10px;">
                                    <div class="d-flex">
                                        <div style="margin-right: 14px;"><img style="width: 60px;" src="https://i.pinimg.com/originals/9c/13/0f/9c130f4a650c7f7c799a898d101c474c.jpg" alt=""></div>
                                        <div>
                                    ...
                                    <div style="margin-left: 80px;">
                                        @if ($comment->replies)
                                            <h4 style="font-weight: bold;">{{$comment->replies->count()}} Replies</h4>
                                            @foreach ($comment->replies as $reply)
                                                <div style="margin-top: 15px; position: relative;">
                                                    <div style="border-bottom: 1px solid green; border-radius: 5px;">
                                                        <div style="margin-right: 14px;"><img style="width: 60px;" src="https://i.pinimg.com/originals/9c/13/0f/9c130f4a650c7f7c799a898d101c474c.jpg" alt=""></div>
                                                        <div>
                                                        <h5 style="font-size: 16px; margin-bottom: 2px;"><a style="font-weight: bold; color: #444444; transition: 0.3s;">{{$reply->author->name}}</a>
                                                            <p>{{$reply->reply}}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        @if (Auth::user())
                                            <div style="margin-top: 30px; padding: 30px; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
                                                <h4 style="font-size: 18px; font-weight: bold;">Reply</h4>
                                                <form method="POST" action="{{url('blog/'.$comment->id.'/save_reply')}}">
                                                    @csrf
                                                    <div class="row">

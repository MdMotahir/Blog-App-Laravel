        ...
        <div class="flex">
            <div class="w-full">
                <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                    ...
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{url('blog/'.$data->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <textarea id="content"
                                class="form-input w-full border @error('content') border-red-500 @enderror" value='{{$data->content}}' name="content" required></textarea>
